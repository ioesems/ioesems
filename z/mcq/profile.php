...
include 'config.php';
include 'syllabus.php'; // keep if you need it
    ...
    <main>
        <div class="profile-card">
            ...
            <div class="profile-stats">
                ...
                <div class="stat-item">
                    <a href="chapter_wise_test.php" class="btn warning" style="padding: 8px 15px; font-size: 14px; margin: 0;">Take Chapter Test</a>
                </div>
            </div>
            ...
            <div style="text-align: center; margin-top: 2rem;">
                ...
                <a href="daily_test.php" class="btn success">🎯 Daily Challenge</a>
                <a href="chapter_wise_test.php" class="btn warning">📖 Chapter Test</a>
