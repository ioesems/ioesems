...
<head>
    ...
    <style>
        ...
        * {
        ...
        .copy-btn:hover { background: #3ab7d1; transform: scale(1.1); }
...
<body>
            ...
            try {
                ...
                if (count($notes) > 0) {
                    foreach ($notes as $note) {
                        ...
                        echo '<button class="action-btn edit-btn" title="Edit" onclick="window.location.href=\'create_and_upload_note.php?id=' . $note['id'] . '\'">';
                        echo '<i class="fas fa-pen"></i></button>';
                        echo '<button class="action-btn delete-btn" title="Delete" onclick="deleteNote(' . $note['id'] . ')">';
                        echo '<i class="fas fa-trash"></i></button>';
                        echo '<button class="action-btn copy-btn" title="Copy" onclick="copyNote(\'' . addslashes($note['title']) . '\', \'' . addslashes($note['content']) . '\')">';
                    ...
                    echo '<p>Try changing your search or add a new note.</p>';
                    echo '</div>';
                }
                ...
                echo '<p>Failed to load notes. Please check your connection.</p>';
                echo '</div>';
            }
            ?>
        </div>
    ...
    <div class="toast" id="toast">Note copied to clipboard!</div>
