...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['answers'])) {
    ...
    header("Location: ../scores/daily_score.php");
    exit();
}
...
if (!$has_taken_today && !isset($_SESSION['daily_questions'])) {
    ...
    header("Location: ../question_fetching/daily_fetch_questions.php");
    exit();
}
?>
    ...
    <div class="container">
        ...
        <?php if ($has_taken_today): ?>
            <div class="message">
                ...
                <a href="../user_files/profile.php" class="submit-btn" style="margin-top: 20px;">View Profile</a>
            </div>
        <?php else: ?>
            <?php
            $questions = $_SESSION['daily_questions'] ?? [];
