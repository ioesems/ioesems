...
<head>
    ...
    <title>KEC Notices - Page <?php echo isset($_GET['page']) ? (int)$_GET['page'] : 1; ?></title>
...
<div class="header-section">
    <div class="container">
        <h1>📢 Kantipur Engineering College Notices</h1>
        <p class="lead">Official notices scraped from <a href="https://kec.edu.np/notice/" target="_blank">kec.edu.np/notice</a></p>
    </div>
</div>
...
<div class="container">
    ...
    function fetchJson($url) {
        ...
        curl_setopt($ch, CURLOPT_USERAGENT, 'KEC Notice Client');
    ...
    $fetchUrl = $baseUrl . 'fetch_kec_notices.php?page=' . $page;
            ...
            if (empty($notices)) {
                ...
                foreach ($notices as $notice) {
                    ...
                    <div class="notice-card">
                        <h3>
                            <a href="' . htmlspecialchars($notice['link']) . '" target="_blank" class="notice-title">
                                ' . htmlspecialchars($notice['title']) . '
                            </a>
                        </h3>
                        <div class="notice-meta">
                            <span class="source-badge">KEC Notice Board</span>
                            <span class="date-badge">Posted</span>
                        </div>
                    </div>';
                }
                echo '</div>';
    ...
    <div class="footer">
        <p>© <?php echo date('Y'); ?> KEC Notices Portal. Not affiliated with KEC. For educational purposes only.</p>
    </div>
