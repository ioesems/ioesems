...
<head>
    ...
    <title><?php echo isset($subject_title) ? $subject_title : 'Question Bank'; ?></title>
...
<body>
    ...
    <!-- Main Content -->
    <div class="content">
        <h1 style="text-align: center; display: none;"><?php echo isset($subject_title) ? $subject_title : 'Question Bank'; ?></h1>
            ...
            foreach ($questions as $chapter) {
                ...
                if (!isset($chapter['questions']) || !is_array($chapter['questions']) || count($chapter['questions']) == 0) {
                    ...
                    foreach ($chapter['questions'] as $index => $q) {
                        ...
                        echo "<div class='question-text'>" . ($index + 1) . ". " . htmlspecialchars($q['text']) . "</div>";
                        
                        // Display year if available
                        if (isset($q['year']) && !empty($q['year'])) {
                            echo "<div class='year'>" . htmlspecialchars($q['year']) . "</div>";
                        }
        ...
        <div class="footer">
            <p><?php echo isset($subject_title) ? $subject_title : 'Question Bank'; ?> &copy; <?php echo date("Y"); ?></p>
            <p>Click on images to view them in full size</p>
        </div>
    </div>
