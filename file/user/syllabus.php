        ...
        <?php if (!empty($syllabus_by_semester)) { ?>
            <?php foreach ($syllabus_by_semester as $semester => $syllabus_list) { ?>
                <div class="semester-section">
                    ...
                    <div id="syllabus-sem<?php echo $semester; ?>" class="syllabus-list">
                        <table>
                            <thead>
                                <tr>
                                    <th>Subject</th>
                                ...
                                <?php foreach ($syllabus_list as $syllabus) { ?>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="view.php?id=<?php echo $syllabus['id']; ?>" target="_blank">View</a>
                                        </td>
            ...
            <?php } ?>
        <?php } else { ?>
            <p>No syllabus found for the selected semester.</p>
        <?php } ?>
    </div>
